...
insert into SYS_POST (post_id, post_title, post_content, user_id, post_time, last_modified_time) values (default, 'Welcome', 'Welcome to the User Management System', 1, now() , CURRENT_TIMESTAMP);