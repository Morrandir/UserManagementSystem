...
create table SYS_REPLY (
  reply_id int generated by default as identity (start with 1 increment by 1) not null,
...
alter table SYS_POST add constraint UNIQUE_SYS_POST_ID unique (post_id);
...
alter table SYS_REPLY add constraint FK_SYS_REPLY_POST_ID foreign key (post_id) references SYS_POST (post_id);
alter table SYS_REPLY add constraint FK_SYS_REPLY_USER_ID foreign key (user_id) references SYS_USER (user_id);
...
insert into SYS_POST (post_id, post_title, post_content, user_id, post_time, last_modified_time) values (default, '11111111111111111111MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMa long title example', '.........................................................<br>.................................................<br>A really long content example...................................', 1, CURRENT_TIMESTAMP , CURRENT_TIMESTAMP);